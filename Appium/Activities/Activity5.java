...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("8007578336");
        // Press ENTER
        ...
        // Assertion
        //wait.until(ExpectedConditions.visibilityOf(driver.findElement(AppiumBy.id("message_text"))));
