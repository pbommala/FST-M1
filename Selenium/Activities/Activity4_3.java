...
public class Activity4_3 {
	    ...
	    public static void main(String[] args) {
	        ...
	        String firstHeader = driver.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div/div/div/div[1]/h1")).getText();
	        System.out.println("First header text is: " + firstHeader);
